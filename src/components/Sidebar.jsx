...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {projects &&
        <div className={`${projects ? "p-3" : "p-0"}  ${projects ? "w-[300px]" : "w-auto"} border  bg-white sidebar flex flex-col ${projects ? "translate-x-0" : "translate-x-[-70px]"}  ease-in-out duration-300`}>
